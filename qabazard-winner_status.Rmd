...
#Round 4
 #Institutional Trust (Police, Court of Law, Army, Electoral Commission)
  ...
  #Elections by Country
    ...
    Round_4$independent[Round_4$Q85 == 9] <- 1
  ...
  #Elections by Country
    ...
    #Election Year
    Round_5$election_year[Round_5$state == 3] <- 2004 #Botswana
    Round_5$election_year[Round_5$state == 11] <- 2004 #Ghana    
    Round_5$election_year[Round_5$state == 14] <- 2007   #Lesotho
    Round_5$election_year[Round_5$state == 17] <- 2004   #Malawi
    Round_5$election_year[Round_5$state == 18] <- 2007 #Mali
    Round_5$election_year[Round_5$state == 22] <- 2004  #Namibia
    Round_5$election_year[Round_5$state == 24] <- 2007  #Nigeria
    Round_5$election_year[Round_5$state == 28] <- 2004 #South Africa
    Round_5$election_year[Round_5$state == 31] <- 2005 #Tanzania
    Round_5$election_year[Round_5$state == 34] <- 2006 #Uganda
    Round_5$election_year[Round_5$state == 35] <- 2006 #Zambia
    Round_5$election_year[Round_5$state == 36] <- 2008 #Zimbabwe
    Round_5$election_year[Round_5$state == 7] <- 2005 #Cape Verde    
    Round_5$election_year[Round_5$state == 13] <- 2007 #Kenya    
    Round_5$election_year[Round_5$state == 21] <- 2004 #Mozambique    
    Round_5$election_year[Round_5$state == 26] <- 2007 #Senegal   
    Round_5$election_year[Round_5$state == 16] <- 2008 #Madagascar
    Round_5$election_year[Round_5$state == 2] <- 2007 #Benin
    Round_5$election_year[Round_5$state == 4] <- 2007 #Burkina Faso
    Round_5$election_year[Round_5$state == 15] <- 2005 #Liberia
    Round_5$state[Round_5$state == 37] <- 37 #Burundi  
    Round_5$state[Round_5$state == 6] <- 6  #Cameroon   
    Round_5$state[Round_5$state == 8] <- 8  #Cote d'Ivoire  
    Round_5$state[Round_5$state == 12] <- 12  #Guinea  
    Round_5$state[Round_5$state == 19] <- 19  #Mauritius  
    Round_5$state[Round_5$state == 24] <- 24  #Niger  
    Round_5$state[Round_5$state == 27] <- 27  #Sierra Leone  
    Round_5$state[Round_5$state == 29] <- 29  #Sudan  
    Round_5$state[Round_5$state == 30] <- 30  #Swaziland  
    Round_5$state[Round_5$state == 32] <- 32  #Togo  
