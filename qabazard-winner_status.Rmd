...
#Round 4
 #Institutional Trust (Police, Court of Law, Army, Electoral Commission)
  ...
  Round_6$mass_media <- Round_5$Q13C + Round_5$Q13B + Round_5$Q13A
  ...
  Round_6$Q52H <- recode(Round_6$Q52H, "998=NA")
  ...
  Round_6$Q52J <- recode(Round_6$Q52J, "998=NA")
  ...
  Round_6$Q52I <- recode(Round_6$Q52I, "998=NA")
  ...
  Round_6$Q52C <- recode(Round_6$Q52C, "998=NA")
  ...
  #Political Interest (This is the interest in public affair variable which is availible in all but the first round. This differrent than the first round because it has four and not three possible response categories!)
  Round_6$Q13 <- recode(Round_6$Q14, "0=0")
  Round_6$Q13 <- recode(Round_6$Q14, "1=1")
  Round_6$Q13 <- recode(Round_6$Q14, "2=2")
  Round_6$Q13 <- recode(Round_6$Q14, "3=3")  
  Round_6$Q13 <- recode(Round_6$Q14, "9=NA")
  Round_6$Q13 <- recode(Round_6$Q14, "98=NA")
  Round_6$Q13 <- recode(Round_6$Q14, "-1=NA")
  
  Round_$interest <- Round_6$Q13
  ...
  #Education (Same applies to do not knows here. This has more categories than the previous item in round 1. It has some high school etc.)
  Round_6$educ <- recode(Round_6$Q97, "0=0")
  Round_6$educ <- recode(Round_6$Q97, "98=NA")
  Round_6$educ <- recode(Round_6$Q97, "99=NA")
  Round_6$educ <- recode(Round_6$Q97, "-1=NA")
  
  #Gender (Female)
  Round_6$gender <- recode(Round_6$Q101, "2=1")
  Round_6$gender <- recode(Round_6$Q101, "1=0")
  
  #Age 
  Round_6$age <- recode(Round_6$Q1, "-1=NA")
  Round_6$age <- recode(Round_6$Q1, "98=NA")
  Round_6$age <- recode(Round_6$Q1, "999=NA")  
  ...
  #Elections by Country
    ...
    Round_6$year_turnover[Round_6$state == 24] <- 1983  #Nigeria
    ...
    Round_6$winner[Round_6$Q90B==903 & Round_6state == 19] <- 1  #Mauritius  
