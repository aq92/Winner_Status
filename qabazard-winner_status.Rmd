...
#Round 2
  ...
  #Government Performance Index
  Round_2$gov_perf <- Round_1$q45g + Round_2$q45f + Round_2$q45b + Round_2$q45c
  ...
  #Economic Satisfaction Index
  Round_2$econ_sat <- Round_1$q1a + Round_1$q4a + Round_1$q3a + Round_1$q1b
...
#NO Electoral Participation Index because none of the items included by Moehler (2009), including whether or not a person voted, are included in this round. 
  ...
  Round_2$educ <- recode(Round_2$educ, "0=0")
  Round_2$educ <- recode(Round_2$educ, "98=NA")
  Round_2$educ <- recode(Round_2$educ, "99=NA")
  Round_2$educ <- recode(Round_2$educ, "-1=NA")
  
  #Gender (Female)
  Round_2$gender <- recode(Round_2$gender, "2=1")
  Round_2$gender <- recode(Round_2$gender, "1=0")
  
  #Age 
  Round_2$age <- recode(Round_2$age, "-1=NA")
  Round_2$age <- recode(Round_2$age, "998=NA")
  Round_2$age <- recode(Round_2$age, "999=NA")  
  ...
  #Elections by Country
    ...
    #Independent
    Round_1$independent <- 0
    Round_1$independent[Round_1$q87a == 0] <- 1
    Round_1$independent[Round_1$q87a == 998] <- NA
    Round_1$independent[Round_1$q87a == 999] <- NA
    Round_1$independent[Round_1$q87a == -1] <- NA
